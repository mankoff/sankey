...
|--------+--------------------------+-------+-----+-----------+-----------------+-----------------------------|
| RF     | Rainfall                 |    50 | I   | 2000-2019 | fettweis_2020   |                             |
| CD     | Condensation             |     5 | I   |           |                 | guesstimate                 |
| DP     | Deposition               |    15 | I   |           |                 | guesstimate                 |
| SF     | Snowfall                 |   710 | I   | 2000-2019 | fettweis_2019   |                             |
| RFZ    | Refreezing               |   205 | IO  | 2000-2019 | fettweis_2020   | RFZ = ME + RF - RU          |
| EV     | Evaporation              |    10 | O   |           |                 | guesstimate                 |
| RU     | Runoff                   |   475 | O   | 2000-2019 | fettweis_2020   |                             |
...
ds = xr.open_dataset('dat/MARv3.12-GRD-15km-annual.nc4')\
    .rename({'X10_110':'X',
             'Y20_200':'Y',
             'TIME':'time'})
...
ds['AREA'] = 15*15
ds = ds[['SF','RF','RU','SU','ME','RFZ','SMB','EVA','CON','DEP','SUB','AREA']]
...
Data variables:
    ...
    SU       float64 8B 56.51
    ME       float64 8B 631.4
    RFZ      float64 8B 205.2
    SMB      float64 8B 228.0
    EVA      float64 8B 8.224
    CON      float64 8B 2.444
    DEP      float64 8B 12.56
    SUB      float64 8B 63.29
    AREA     float64 8B 0.05063
#+end_example
