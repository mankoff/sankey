...
\begin{tikzpicture}[remember picture, overlay, shift={(5.5,-5.5)}]
  ...
  \begin{sankeydiagram}
    ...
    %% LEGEND
    \sankeynode[air]{name=LEG-AIR, quantity=30, at={[yshift=35mm]SF.top}}
    \sankeyadvance[air]{LEG-AIR}{4mm}
    \node[align=right, shift=({5mm,2mm})] at (LEG-AIR) {Air};
    \sankeynode[ice]{name=LEG-ICE, quantity=30, at={[yshift=-1mm]LEG-AIR.bottom}}
    \sankeyadvance[ice]{LEG-ICE}{4mm}
    \node[align=right, shift=({5mm,2mm})] at (LEG-ICE) {Ice};
    \sankeynode[water]{name=LEG-H2O, quantity=30, at={[yshift=-1mm]LEG-ICE.bottom}}
    \sankeyadvance[water]{LEG-H2O}{4mm}
    \node[align=left, shift=({7mm,2mm})] at (LEG-H2O) {Water};
