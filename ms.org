...
A similar display to the diagrams presented here, by \citet[][Figure 2]{cogley_2011}, shows glacial processes overlaid on a glacier schematic. We build on that work by adding magnitude of processes and making the graphics proportional to magnitudes.
