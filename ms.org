...
Ice mass loss in Greenland is 330 \pm35 Gt yr^{-1} which is ~30 % larger than the 255 \pm25 Gt yr^{-1} grounded ice mass loss estimates that neglect floating ice changes. Ice mass loss in Antarctica is 450 \pm140 Gt yr^{-1} which is ~240 % larger than the 190 \pm60 Gt yr^{-1} grounded ice mass loss estimates. Freshwater mass flow rate from Greenland is ~1065 \pm120 Gt yr^{-1} or ~3x mass loss (~4x grounded mass loss), and from Antarctica is ~3110 \pm1515 Gt yr^{-1}, or ~7x mass loss (~17x grounded mass loss).
