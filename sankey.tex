...
\begin{tikzpicture}[remember picture, overlay, shift={(5.5,-1.5)}]
  ...
  \begin{sankeydiagram}
    ...
    \newcommand\abovelabel[1]{ % valname
      \node[font=\tiny, rotate=45, anchor=north west]
      at ([yshift=5mm,xshift=-3mm]#1.center) {\qq{#1}: \Lab{v#1}};
    }
    \newcommand\belowlabel[2]{ % valname
      \node[font=\tiny, rotate=45, anchor=north east]
      at ([yshift=-2mm,xshift=0mm]#1.center) {\Lab{#2}: \qq{#1}};
    }
    ...
    \belowlabel{RU}{vRU}
    \belowlabel{BMa}{vBM}
    \belowlabel{SUBa}{vSUB}
    \belowlabel{D}{vICE}
    \belowlabel{GZa}{vGZRET}

    \node[font=\tiny, rotate=45, anchor=north east]
    at ([yshift=1mm,xshift=3mm]SUaa.south) {\Lab{vSU}: \qq{SUaa}};

    \node[font=\tiny, rotate=45, anchor=north east]
    at ([yshift=0mm,xshift=5mm]EVa.north) {\Lab{vEV}: \qq{EVa}};
