...
\begin{tikzpicture}[remember picture, overlay, shift={(5.5,-1.5)}]
  ...
  \begin{sankeydiagram}
    ...
    \ifnum \numexpr\Q{vMG} > \Q{vML}
      ...
      at ([yshift=-5mm,xshift=9mm]MGa.bottom) {\qq{MGa}: Accumulation};
    ...
    \ifthenelse{\Q{vMG} < \Q{vML}}
      ...
      \belowlabel{FRa}{Frontal retreat}

      \node[font=\tiny, anchor=north]
      at ([yshift=-2mm,xshift=3mm]SUaa.bottom) {\qq{SUa}: Sublimation};

      \node[font=\tiny, anchor=north]
      at ([yshift=-2mm,xshift=0mm]EVa.bottom) {\qq{EVa}: Evaporation};
