...
\begin{tikzpicture}[remember picture, overlay, shift={(5,-5)}]
  ...
  \begin{sankeydiagram}
    ...
    \sankeyset{
      ...
      def data/.list={
        ...
        {vML/Mass loss/
          ...
          (\Q{vSF}+\Q{vRF}+\Q{vCD}+\Q{vDP}+\Q{vFRGAIN}+\Q{vSUBF})},
        {vMG/Mass gain/
          (\Q{vSF}+\Q{vRF}+\Q{vCD}+\Q{vDP}+\Q{vFRGAIN}+\Q{vSUBF})-
          (\Q{vSU}+\Q{vRU}+\Q{vBM}+\Q{vDYN}+\Q{vFRLOSS}+\Q{vGZRET}+\Q{vEV})}
      },
    ...
    \sankeynode{name=SUBF, quantity=\Q{vSUBF},
      at={[yshift=-\yoff]SF.south}, anchor=left}

    \ifthenelse{\Q{vMG} > \Q{vML}} {
      \sankeynode{name=f1, quantity=\Q{vRFZ}+\qq{f0}+\Q{vFRGAIN}+\Q{vSUBF},
        at={[xshift=30mm, yshift=\yoff]SUBF.south}, anchor=right,
        forked={\Q{vRFZ}/RFZi, \Q{vFRGAIN}/FG, \qq{f0}/f0i, \Q{vSUBF}/SUBFi}}
    } {
      \sankeynode{name=f1, quantity=\Q{vRFZ}+\qq{f0}+\Q{vML}+\Q{vFRGAIN}+\Q{vSUBF},
        at={[xshift=30mm, yshift=\yoff]SUBF.south}, anchor=right,
        forked={\Q{vRFZ}/RFZi, \Q{vFRGAIN}/FG, \Q{vML}/MLi, \qq{f0}/f0i, \Q{vSUBF}/SUBFi}}
    }
    ...
    \ifnum \numexpr\Q{vSUBF} > 0
    \labelleft{SUBF}
    \sankeystart[water]{SUBF}
    \sankeydubins[water-to-ice]{SUBF}{SUBFi}
    \fi
    ...
    \ifnum \numexpr\Q{vMG} > \Q{vML}
      ...
      \sankeyoutin[ice-to-black]{MG}{MGa}
    \fi
    ...
    \node[font=\tiny, anchor=east]
    at ([yshift=+1.5mm,xshift=1mm]RFZo.center) {\Lab{vRFZ}: \qq{RFZi}};
