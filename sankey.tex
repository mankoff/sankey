...
\edef\jobnameclean{\detokenize\expandafter{\jobname}}
  ...
  \begin{sankeydiagram}
    ...
    \sankeyset{
      ...
      def data/.list={
        ...
        {vINPUT/Inputs/\Q{vSMBin}+\Q{vSHELFFREEZE}},
        {vSMBout/SMB Outputs/\Q{vSU}+\Q{vRU}+\Q{vEV}},
        {vDYN/Dynamics/\Q{vCALV}+\Q{vFRONTMELT}+\Q{vSHELFMELT}+\Q{vGZRET}+\Q{vBMB}},
    ...
    \ifthenelse{\Q{vML} > \Q{vMG}} { % mass loss
      \sankeynode{name=f1, at={[xshift=30mm, yshift=0mm]RFi.north}, anchor=left,
        quantity=\qq{SMBIN}+\Q{vSHELFFREEZE}+\Q{vML}+\Q{vRFZ},
        forked={\Q{vRFZ}/RFZi, \qq{SMBIN}/SMBINi, \Q{vSHELFFREEZE}/SHELFFREEZEi,
          \Q{vML}/MLi}}
    } { % mass gain edge case
      \sankeynode{name=f1, at={[xshift=30mm, yshift=0mm]RFi.north}, anchor=left,
        quantity=\qq{SMBIN}+\Q{vSHELFFREEZE}+\Q{vRFZ},
        forked={\Q{vRFZ}/RFZi, \qq{SMBIN}/SMBINi, \Q{vSHELFFREEZE}/SHELFFREEZEi}}
    }
    ...
    \sankeyend[air]{EVa};
    \node[font=\small, anchor=west] at ([yshift=0mm,xshift=\yoff]EVa.west) {\qq{EVa}: \Lab{vEV}};
    ...
    \node[font=\small, anchor=west] at ([yshift=4mm,xshift=\yoff]SUa.west) {\qq{SUa}: \Lab{vSU}};
    ...
    \ifthenelse{\Q{vMG} < \Q{vML}} { % mass loss
      ...
      node[left,font=\small,anchor=east,text=black] {Mass loss: \Q{vML}};
    }{ % mass gain
      ...
      node[below,font=\small,text=black] {Mass gain: \qq{MG}};
    }

    \ifnum\pdfmatch{E}{\jobname}>0
    \node at (5.25,0) {East};
    \else\ifnum\pdfmatch{W}{\jobname}>0
    \node at (5.25,0) {West};
    \else\ifnum\pdfmatch{P}{\jobname}>0
    \node at (5.25,-0.15) {Peninsula};
    \fi\fi\fi
