...
\begin{tikzpicture}[remember picture, overlay, shift={(5,-5)}]
  ...
  \begin{sankeydiagram}
    ...
    \sankeyfork{f1}{\Q{vRFZ}/RFZo, \Q{vSU}/SU, \Q{vRU}+\Q{vEV}/RUEV,
      \Q{vCALV}+\Q{vFRONTMELT}/DISCH, \Q{vSHELFMELT}/SHELFMELT,
    ...
    \sankeyadvance{DISCH}{10mm}
    \sankeyfork{DISCH}{\Q{vCALV}/CALV, \Q{vFRONTMELT}/FRONTMELT}
    
    \sankeynode{name=SHELFMELTa,quantity=\qq{SHELFMELT}, at={[yshift=-\yoff, xshift=10mm]FRONTMELT.right}}
    \sankeynode{name=FRONTRETa, quantity=\qq{FRONTRET}, at={[yshift=-\yoff]SHELFMELTa.right}}
    \sankeyadvance[ice-to-water]{FRONTMELT}{10mm}
    \sankeynode{name=CALVa, quantity=\qq{CALV}, at={[yshift=\yoff]FRONTMELT.left}, anchor=right}
    ...
    \sankeyoutin[ice-to-water]{BMB}{BMBa}
    \sankeyoutin[ice-to-water]{GZ}{GZa}

    %% Finish dynamic outputs
    \sankeyadvance{CALVa}{10mm}; \sankeyend{CALVa}; \labelright{CALVa}{vCALV}
    \sankeyadvance[water]{FRONTMELT}{10mm}; \sankeyend[water]{FRONTMELT}; \labelright{FRONTMELT}{vFRONTMELT}
    \sankeyadvance[water]{SHELFMELTa}{10mm}; \sankeyend[water]{SHELFMELTa}; \labelright{SHELFMELTa}{vSHELFMELT}
    \sankeyadvance[out-blue]{FRONTRETa}{10mm}; \sankeyend[out-blue]{FRONTRETa}; \labelbold{FRONTRETa}{vFRONTRET}
    \sankeyadvance[water]{GZa}{10mm}; \sankeyend[water]{GZa}; \labelbold{GZa}{vGZRET}
    \sankeyadvance[water]{BMBa}{10mm}; \sankeyend[water]{BMBa}; \labelright{BMBa}{vBMB}

    
    %% SMB outputs
    \sankeynode{name=RUEVa, quantity=\qq{RUEV}, at={[yshift=\yoff, xshift=-10mm]CALVa.left}, anchor=right}
    ...
    \node[font=\tiny, anchor=east]
    at ([xshift=-3mm,yshift=2mm]ML.west) {\textbf{Glacier drawdown: \qq{ML}}};
