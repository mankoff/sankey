...
\begin{tikzpicture}[remember picture, overlay, shift={(5.5,-5.5)}]
  ...
  \begin{sankeydiagram}
    ...
    \sankeyset{ice}
    \sankeynode{ name=MG, quantity=\Q{FRET}+\Q{IL}, at={[xshift=8mm]SF.left}, anchor=right}
    \sankeystart[red]{MG}
    \sankeyadvance[red-to-ice]{MG}{1cm}
    \sankeyfork{MG}{\Q{FRET}/FRET, \Q{IL}/IL}
    ...
    \node[anchor=center, align=center, shift=({0cm,2.25cm})] at (MG.center) {Mass loss (\sankeygetnodeqty{MG}) = \\SMB \& Dynamics (\sankeygetnodeqty{IL})\\+ Frontal retreat (\sankeygetnodeqty{FRET})};
